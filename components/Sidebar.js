...
function sidebar() {
  ...
  return (
    <div className="border-r border-gray-900 p-5 text-xs lg:text-sm overflow-y-scroll scrollbar-hide h-screen text-gray-500 sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex " >
